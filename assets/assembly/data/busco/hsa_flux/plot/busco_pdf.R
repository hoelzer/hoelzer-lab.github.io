...
# Output
my_output <- paste("/mnt/dessertlocal/projects/transcriptome_assembly/review/evaluation/busco/hsa_flux/plot/","busco_figure.pdf",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('hsa_flux_trinity', 'hsa_flux_trinity', 'hsa_flux_trinity', 'hsa_flux_trinity', 'hsa_flux_shannon', 'hsa_flux_shannon', 'hsa_flux_shannon', 'hsa_flux_shannon', 'hsa_flux_idba-tran', 'hsa_flux_idba-tran', 'hsa_flux_idba-tran', 'hsa_flux_idba-tran', 'hsa_flux_rna-spades', 'hsa_flux_rna-spades', 'hsa_flux_rna-spades', 'hsa_flux_rna-spades', 'hsa_flux_binpacker', 'hsa_flux_binpacker', 'hsa_flux_binpacker', 'hsa_flux_binpacker', 'hsa_flux_trans-abyss', 'hsa_flux_trans-abyss', 'hsa_flux_trans-abyss', 'hsa_flux_trans-abyss', 'hsa_flux_soap-trans-default', 'hsa_flux_soap-trans-default', 'hsa_flux_soap-trans-default', 'hsa_flux_soap-trans-default', 'hsa_flux_oases', 'hsa_flux_oases', 'hsa_flux_oases', 'hsa_flux_oases', 'hsa_flux_bridger', 'hsa_flux_bridger', 'hsa_flux_bridger', 'hsa_flux_bridger', 'hsa_flux_spades', 'hsa_flux_spades', 'hsa_flux_spades', 'hsa_flux_spades')
...
my_percentage <- c(32.3, 55.3, 8.5, 3.9, 21.3, 14.8, 9.7, 54.2, 33.7, 0.0, 45.2, 21.1, 40.2, 28.6, 27.3, 3.9, 38.2, 40.4, 17.1, 4.3, 45.9, 34.1, 16.8, 3.2, 28.5, 14.6, 40.7, 16.2, 12.8, 78.5, 5.4, 3.3, 47.1, 31.1, 17.6, 4.2, 60.7, 0.0, 31.1, 8.2)
my_values <- c(217, 371, 57, 26, 143, 99, 65, 364, 226, 0, 303, 142, 270, 192, 183, 26, 256, 271, 115, 29, 308, 229, 113, 21, 191, 98, 273, 109, 86, 527, 36, 22, 316, 209, 118, 28, 407, 0, 209, 55)
