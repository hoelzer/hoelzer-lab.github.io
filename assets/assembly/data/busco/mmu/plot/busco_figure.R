...
# Output
my_output <- paste("/mnt/dessertlocal/projects/transcriptome_assembly/review/evaluation/busco/mmu/plot/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('mmu_rna-spades', 'mmu_rna-spades', 'mmu_rna-spades', 'mmu_rna-spades', 'mmu_spades', 'mmu_spades', 'mmu_spades', 'mmu_spades', 'mmu_binpacker', 'mmu_binpacker', 'mmu_binpacker', 'mmu_binpacker', 'mmu_shannon', 'mmu_shannon', 'mmu_shannon', 'mmu_shannon', 'mmu_idba-tran', 'mmu_idba-tran', 'mmu_idba-tran', 'mmu_idba-tran', 'mmu_trans-abyss', 'mmu_trans-abyss', 'mmu_trans-abyss', 'mmu_trans-abyss', 'mmu_trinity', 'mmu_trinity', 'mmu_trinity', 'mmu_trinity', 'mmu_soap-trans-default', 'mmu_soap-trans-default', 'mmu_soap-trans-default', 'mmu_soap-trans-default', 'mmu_bridger', 'mmu_bridger', 'mmu_bridger', 'mmu_bridger', 'mmu_oases', 'mmu_oases', 'mmu_oases', 'mmu_oases')
...
my_percentage <- c(50.1, 10.9, 8.7, 30.3, 61.5, 0.2, 7.9, 30.4, 3.5, 1.5, 0.2, 94.8, 37.7, 8.0, 13.4, 40.9, 43.0, 0.3, 21.4, 35.3, 35.0, 29.5, 4.4, 31.1, 41.6, 21.3, 5.5, 31.6, 55.8, 2.6, 9.5, 32.1, 45.8, 17.4, 5.7, 31.1, 24.7, 24.8, 10.5, 40.0)
my_values <- c(3100, 673, 539, 1880, 3809, 14, 492, 1877, 217, 93, 11, 5871, 2333, 496, 829, 2534, 2661, 18, 1325, 2188, 2165, 1827, 274, 1926, 2577, 1318, 338, 1959, 3454, 162, 589, 1987, 2836, 1078, 352, 1926, 1529, 1537, 650, 2476)
